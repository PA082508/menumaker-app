...
## PIN, подмена и непрерывность взрослого

**PIN своим людям заводите вы.** Карточка сотрудника → **DOOR PIN → Set PIN**: четыре цифры,
вводятся дважды, больше нигде не показываются — ни в карточке, ни в списке, ни письмом. Забыл —
заводите новый; старый не восстанавливается никем. Слишком простые комбинации (1111, 1234, 4321)
не примутся, занятый в центре PIN попросит выбрать другой. Администрация организации заводит PIN
только в аварийном случае, когда вас нет на месте, — след «кем и когда» остаётся в карточке.

**Подмена отмечается своим PIN на планшете комнаты**, а не «под учителем»: отметки должны нести
имя того, кто их делал.

**Последнего взрослого система не отпускает, пока в комнате дети** и не пришла подмена; уход через
«Leave anyway» записывается как исключение с числом детей — это то, что вам нужно увидеть и
разобрать. Сегодня гейт считает детьми тех, кто принят через SafePass, и до первых подтверждённых
передач он дремлет; правило для людей действует уже сейчас.

**Правовая рамка.** Ohio Administrative Code **5180:2-12-09** требует непрерывного присмотра и
соблюдения соотношений «персонал — дети»; **5180:2-12-18** требует вести и хранить записи о
посещаемости и присмотре. Отказ отпустить последнего взрослого — техническое выражение первого
требования; журнал чек-инов и исключений — второго.
