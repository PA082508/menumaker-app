...
**Признак для поиска остального:** у каждого `on conflict` / уникального индекса спросить — **есть
ли в списке колонок хоть одно поле, которое человек может написать двумя способами?** Если да, это
не ключ, это генератор дублей.
