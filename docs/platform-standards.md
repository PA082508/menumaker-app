...
обязана нести кнопку возврата к началу. Общий компонент — `src/components/common/ScrollToTop.tsx`;
...
**Порог — два экрана, и считается он от высоты окна**, а не от числа пикселей: на планшете
повара и на мониторе офиса «два экрана» — разные величины. Кнопка на короткой странице
запрещена: она закрывает собой содержимое и не экономит ничего.
