...
const DOCS = [
  ...
  { id:'safepass-parent-addendum', title:'SafePass — Parent Handbook Addendum', description:'The addendum to the Parent Handbook: registration with a photo, daily use, authorized pickup, the personal QR for adults without a smartphone, voluntary e-signature, OAC 5180:2-12-09 / -18. Read-only — the signed instrument is the handbook receipt.', audience:'Parent', category:'SafePass', driveUrl:letterUrl('ridge','safepass_parent_addendum_ridge') },
  ...
  { id:'safepass-driver', title:'SafePass — Driver (Transport)', description:'Opens Teacher View (temporary). The driver surface is in development.', audience:'Staff', category:'SafePass', driveUrl:'https://menumaker-app.vercel.app/safepass/teacher' },
  { id:'safepass-director', title:'SafePass — Director Dashboard', description:'Opens Teacher View (temporary). The director dashboard is in development.', audience:'Director', category:'SafePass', driveUrl:'https://menumaker-app.vercel.app/safepass/teacher' },
