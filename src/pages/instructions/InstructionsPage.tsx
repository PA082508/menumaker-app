...
const DOCS = [
  ...
  { id:'byod-policy', title:'BYOD Policy HR-BYOD-001', description:'Voluntary participation, $20/month stipend, privacy protections.', audience:'Staff', category:'BYOD' },
  { id:'safepass-parent', title:'SafePass — Parent Letter (Wickliffe)', description:'Pilot announcement. Registration July 1-14, mandatory July 15.', audience:'Parent', category:'SafePass' },
  { id:'safepass-teacher', title:'SafePass — Teacher Quick Guide', description:'iPad guide: drop-off, pick-up, unknown person protocol.', audience:'Teacher', category:'SafePass' },
  { id:'safepass-concept', title:'SafePass — Concept Document v1.1', description:'Full concept: legal basis, chain of custody, transportation, school partnership.', audience:'Director', category:'SafePass' },
