...
--      20260731b (схлопывание сирот) УЖЕ применён 01.08 — расщеплённых групп 0,
--      гард ниже сегодня прошёл бы.
--
-- 🔴 ПРЕДПРОВЕРКА 02.08 ДАЛА СТОП. Ключ НЕ ПОШЁЛ, и вот почему — три отказа:
--
