-- 20260731c — ПРИМЕНЕНО НА БОЙ 2026-07-31 по слову владельца.
--
-- READ-BACK (снят до и после, только чтение):
--   приёмы июль   3889 / 2455 / 6824      (Highland / Pearl / Ridge) — БЕЗ ДВИЖЕНИЯ
--   ADA    июль     66 /   41 /  110                                 — БЕЗ ДВИЖЕНИЯ
--   деньги июль 6566.75 / 4768.23 / 14242.01                         — БЕЗ ДВИЖЕНИЯ
--   июнь          4017 / 1929 / 3768, ADA 80 / 39 / 129              — БЕЗ ДВИЖЕНИЯ
--   комнат в новом блоке 7 / 6 / 11; сумма по комнатам = итогу приёмов ДО ЕДИНИЦЫ.
--
